            ...
            <div className="content">
                ...
                <div className="userInfo">
                    ...
                    <div className="switch" id="switchTweets">
                        ...
                        <Link to={`/user/${user}/with_replies`}><button className="active">Tweets & replies</button></Link>
                ...
                <div className="userTweets">
                    <TweetList userId={user} getTotalTweets={total => setTotalTweets(total)} filter={'replies'} />
                </div>
            </div>
        </div>
    )
